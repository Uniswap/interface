...
fs.writeFileSync(path.join(__dirname, '../src/utils/validateTokenList.js'), tokenListModuleCode)
...
fs.writeFileSync(path.join(__dirname, '../src/utils/validateTokens.js'), tokensModuleCode)
