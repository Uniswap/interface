...
describe('metaTagInjectionMiddleware', () => {
  test('should inject meta tags for matching paths', async () => {
    ...
    expect(responseText).toContain('<meta property="og:title" content="HookSwap Interface"')
    ...
    expect(responseText).toContain('<meta property="og:image:alt" content="HookSwap Interface"')
