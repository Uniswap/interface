...
const Balance = ({ currency, chainId = ChainId.CELO, gqlBalance, onClick }: BalanceProps) => {
  ...
  return (
    <BalanceSection>
      ...
      {otherChainBalances.map((balance) => {
        ...
        const chainId = (balance.token && supportedChainIdFromGQLChain(balance.token.chain)) ?? ChainId.CELO
        return (
          <Balance
            key={balance.id}
            currency={currency}
