...
export function FOTTooltipContent() {
  return (
    <BaseTooltipContent url="https://support.ring.exchange/hc/en-us/articles/18673568523789-What-is-a-token-fee-">
...
function SwapFeeTooltipContent({ hasFee }: { hasFee: boolean }) {
  ...
  return (
    <BaseTooltipContent url="https://support.ring.exchange/hc/en-us/articles/20131678274957">
      {message}
    </BaseTooltipContent>
  )
}
...
function MinimumOutputTooltipContent({ amount }: { amount: CurrencyAmount<Currency> }) {
  ...
  return (
    <BaseTooltipContent url="https://support.ring.exchange/hc/en-us/articles/8643794102669-Price-Impact-vs-Price-Slippage">
