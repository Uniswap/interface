...
const TransactionTitleTable: { [key in TransactionType]: { [state in TransactionStatus]: string } } = {
  ...
  [TransactionType.MORPHO_SUPPLY]: {
    [TransactionStatus.Pending]: i18n.t('common.supplying'),
    [TransactionStatus.Confirmed]: i18n.t('common.supplied'),
    [TransactionStatus.Failed]: i18n.t('common.supply.failed'),
  },
  [TransactionType.MORPHO_AUTHORIZATION]: {
    [TransactionStatus.Pending]: i18n.t('common.authorizing'),
    [TransactionStatus.Confirmed]: i18n.t('common.authorized'),
    [TransactionStatus.Failed]: i18n.t('common.authorize.failed'),
  },
  [TransactionType.MORPHO_REDEEM]: {
    [TransactionStatus.Pending]: i18n.t('common.redeeming'),
    [TransactionStatus.Confirmed]: i18n.t('common.redeemed'),
    [TransactionStatus.Failed]: i18n.t('common.redeem.failed'),
  },
}
...
export const CancelledTransactionTitleTable: { [key in TransactionType]: string } = {
  ...
  [TransactionType.MORPHO_SUPPLY]: i18n.t('common.supply.cancelled'),
  [TransactionType.MORPHO_AUTHORIZATION]: i18n.t('common.authorization.cancelled'),
  [TransactionType.MORPHO_REDEEM]: i18n.t('common.redeem.cancelled'),
}
