...
import { InterfaceSearchResultSelectionProperties, NavBarSearchTypes } from 'uniswap/src/features/telemetry/types'
...
function SearchBarDropdownContents({ toggleOpen, tokens, queryText, hasInput }: SearchBarDropdownProps): JSX.Element {
  ...
  const totalSuggestions = hasInput ? tokens.length : Math.min(shortenedHistory.length, 2) + popularTokens.length
    ...
    <Flex gap="$spacing20">
      {tokens.length > 0 ? (
        <SearchBarDropdownSection
          ...
          suggestions={tokens}
          eventProperties={{
            suggestion_type: NavBarSearchTypes.TokenSuggestion,
            ...eventProperties,
          }}
    ...
    <Flex gap="$spacing20">
      {shortenedHistory.length > 0 && (
        <SearchBarDropdownSection
          ...
          eventProperties={{
            suggestion_type: NavBarSearchTypes.RecentSearch,
            ...eventProperties,
          }}
      ...
      <SearchBarDropdownSection
        ...
        eventProperties={{
          suggestion_type: NavBarSearchTypes.TokenTrending,
          ...eventProperties,
        }}
