...
describe('RouterLabel', () => {
  it('renders correct label for UniswapX trade', () => {
    ...
    expect(screen.getByText('Ring X')).toBeInTheDocument()
  })
