...
function useDropdownOptions(
  ...
  return useMemo(() => {
    ...
    if (liquidityPosition.version === ProtocolVersion.V2 || liquidityPosition.version === ProtocolVersion.Fewv2) {
    ...
    return [collectFeesOption, addLiquidityOption, removeLiquidityOption, poolInfoOption, hideOption].filter(
