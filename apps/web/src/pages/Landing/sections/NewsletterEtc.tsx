        ...
        <SectionCol justifyContent="space-between" height="100%">
          ...
          <Layout>
            <SquareCard
              ...
              backgroundColor="rgba(92, 138, 255, 0.06)"
              $theme-dark={{
            ...
            <SquareCard
              group="card"
              href="https://ringprotocol.gitbook.io/ring/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <PillButton icon={<BookOpen fill={blogPrimary} />} color={blogPrimary} label={t('common.docs')} />
            ...
            <RectCard
              group="card"
              href="https://twitter.com/ProtocolRing/"
              target="_blank"
              rel="noopener noreferrer"
