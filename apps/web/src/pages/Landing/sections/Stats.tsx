...
function LearnMore() {
  ...
  return (
    <LearnMoreButton href="/explore">
      <ExternalLink href={getInternalLinkHref('/explore')}>
    ...
    <GridArea>
      <LeftTop>
        <StatCard
          ...
          value={formatNumber({ input: 4.8 * 10 ** 9, type: NumberType.FiatTokenStats })}
          delay={0}
          inView={inView}
        />
      </LeftTop>
      <RightTop>
        <StatCard
          ...
          value={formatNumber({ input: 5.79 * 10 ** 4, type: NumberType.TokenQuantityStats })}
          delay={0.2}
          inView={inView}
        />
      </RightTop>
      <LeftBottom>
        <StatCard
          ...
          value={formatNumber({ input: 1.26 * 10 ** 7, type: NumberType.FiatTokenStats })}
          delay={0.4}
          inView={inView}
        />
      </LeftBottom>
      <RightBottom>
        <StatCard
          ...
          value={formatNumber({ input: totalVolume || 13500000, type: NumberType.FiatTokenStats })}
          live
          delay={0.6}
          inView={inView}
        />
