  ...
  return (
    <Flex row gap="$spacing24" maxHeight={iconSize} alignItems="flex-start">
      <SocialIcon $hoverColor="#00C32B">
        <Anchor href="https://github.com/RigoBlock" target="_blank">
          <Github size={iconSize} fill="inherit" />
        </Anchor>
      </SocialIcon>
      <SocialIcon $hoverColor="#20BAFF">
        <Anchor href="https://x.com/RigoBlock" target="_blank">
    ...
    <Flex width="100%" gap="$spacing24" pt="$none" px="$spacing48" pb="40px" $lg={{ px: '$spacing40' }}>
      ...
      >
        ...
        <Flex row alignItems="center" gap="$spacing16">
          <Anchor textDecorationLine="none" href="https://rigoblock.com/legal" target="_blank">
