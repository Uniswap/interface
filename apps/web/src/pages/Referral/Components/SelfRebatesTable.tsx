...
function getTxLink(item?: SelfRebateItem): string | undefined {
...
export function SelfRebatesTable({
  data,
  loading,
  page,
  pageCount,
  ...
  const columns = useMemo(() => {
    const columnHelper = createColumnHelper<SelfRebateItem>()
    ...
    return [
      ...
      columnHelper.accessor((row) => row.selfRebatePoints, {
        id: 'points',
        size: 120,
        header: () => (
          <HeaderCell>
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <Flex flexDirection="column" gap="$spacing2">
              ...
              <Text variant="body3" color="$neutral1">
                {formatPoints(item.selfRebatePoints)}
              </Text>
            </Flex>
            <Flex flexDirection="column" gap="$spacing2">
              <Text variant="body4" color="$neutral2">
