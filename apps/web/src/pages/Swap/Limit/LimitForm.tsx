...
const LIMIT_FORM_CURRENCY_SEARCH_FILTERS: CurrencySearchFilters = {
...
function LimitForm({ onCurrencyChange }: LimitFormProps) {
  ...
  useEffect(() => {
    ...
    const marketPriceString = formatCurrencyAmount({
      amount: marketPrice.quote(CurrencyAmount.fromRawAmount(inputCurrency, 10 ** inputCurrency.decimals)),
  ...
  }, [formatCurrencyAmount, inputCurrency, limitState.limitPriceEdited, marketPrice, outputCurrency, setLimitState])
