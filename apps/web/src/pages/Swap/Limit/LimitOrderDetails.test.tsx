import { SlippageTooltipContent } from '~/features/Swap/SwapLineItemTooltips'
...
describe('LimitOrderDetails.tsx', () => {
  beforeEach(() => {
  ...
  it('shows accept changes section when available', () => {
    ...
    render(
      <LimitOrderDetails
        ...
        limitOrderResult={undefined}
        onConfirm={vi.fn()}
        limitOrderErrorMessage={undefined}
