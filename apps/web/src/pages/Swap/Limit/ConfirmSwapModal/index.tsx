...
import SwapError, { PendingModalError } from '~/pages/Swap/Limit/ConfirmSwapModal/Error'
...
import SwapProgressIndicator from '~/pages/Swap/Limit/ConfirmSwapModal/ProgressIndicator'
