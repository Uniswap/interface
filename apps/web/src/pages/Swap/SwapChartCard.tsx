...
import { Flex, Loader, styled, Text, TouchableArea, useShadowPropsShort } from 'ui/src'
...
/** Matches the chart placeholder height from the original SwapChartCard design. */
...
interface SwapChartCardContentProps {
...
}: SwapChartCardContentProps): JSX.Element {
...
interface SwapChartCardBodyProps {
...
function SwapChartCardBody({
  ...
  selectedField,
  onSelectedFieldChange,
}: SwapChartCardBodyProps): JSX.Element {
  ...
  return (
    <>
      ...
      <Flex row alignItems="center" px="$spacing8">
        ...
        <TouchableArea onPress={() => navigateToTokenDetails(selectedCurrency, selectedCurrency.chainId)}>
...
export function SwapChartCard(): JSX.Element {
