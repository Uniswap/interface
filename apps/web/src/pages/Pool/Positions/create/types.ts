...
export type CreateFewV2PositionInfo = BaseCreatePositionInfo & {
...
export type FewV2PriceRangeInfo = BasePriceRangeInfo & {
  protocolVersion: ProtocolVersion.Fewv2
  mockPair?: FewPair
}

export type PriceRangeInfo = V4PriceRangeInfo | V3PriceRangeInfo | V2PriceRangeInfo | FewV2PriceRangeInfo
