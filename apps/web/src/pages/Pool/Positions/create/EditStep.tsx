...
import { getCreatePositionProtocolLabel } from 'pages/Pool/Positions/create/routeVariant'
...
export const EditSelectTokensStep = (props?: FlexProps) => {
  ...
  const versionLabel = getCreatePositionProtocolLabel(protocolVersion, positionState.routeVariant)
