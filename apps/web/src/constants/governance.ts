...
export const COMMON_CONTRACT_NAMES: Record<number, { [address: string]: string }> = {
  [ChainId.X1]: {
    [UNI_ADDRESSES[ChainId.X1]]: 'UNI',
    [TIMELOCK_ADDRESSES[ChainId.X1]]: 'Timelock',
    [GOVERNANCE_ALPHA_V0_ADDRESSES[ChainId.X1]]: 'Governance (V0)',
    [GOVERNANCE_ALPHA_V1_ADDRESSES[ChainId.X1]]: 'Governance (V1)',
    [GOVERNANCE_BRAVO_ADDRESSES[ChainId.X1]]: 'Governance',
