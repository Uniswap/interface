...
import { initToucanBidDistributionChart } from '~/features/Toucan/ToucanChart/bidDistribution/controller/lifecycle/init'
import { computeBidLineTooltipState } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/bidLineTooltip'
import { getSelectedTickPriceFromChartClick } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/chartClick'
import { computeClearingPriceTooltipState } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/clearingPriceTooltip'
import { handleToucanCrosshairMove } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/crosshairMove'
import { recenterRangeOnBid } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/outOfRangeRecenter'
import {
  canExtendChartToBid,
  updateBidDistributionOverlays,
} from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/overlays'
import {
  applyZoomFromState,
  captureZoomState,
} from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/zoom'
import type {
...
} from '~/features/Toucan/ToucanChart/bidDistribution/types'
import { constrainVisibleRangeToBounds } from '~/features/Toucan/ToucanChart/bidDistribution/utils/visibleRange'
import type { ToucanChartSeriesOptions } from '~/features/Toucan/ToucanChart/renderer'
import type { ToucanChartSeries } from '~/features/Toucan/ToucanChart/toucan-chart-series'
import { createConcentrationGradientColors, getChartBarColors } from '~/features/Toucan/ToucanChart/utils/colors'
import { getNiceStepForMaxLabels, getPrecisionForMinMove } from '~/features/Toucan/ToucanChart/utils/yAxisLabels'
import { calculateZoomedRange } from '~/features/Toucan/ToucanChart/utils/zoomRange'
/**
 * Responsibilities:
