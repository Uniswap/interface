...
import { useChartLabels } from '~/features/Toucan/Auction/BidDistributionChart/hooks/useChartLabels'
import { useTickGrouping } from '~/features/Toucan/Auction/BidDistributionChart/hooks/useTickGrouping'
import { useTooltipOverlapDetection } from '~/features/Toucan/Auction/BidDistributionChart/hooks/useTooltipOverlapDetection'
import { useToucanBidDistributionChartLabels } from '~/features/Toucan/Auction/BidDistributionChart/hooks/useToucanBidDistributionChartLabels'
import { BidMarkerOverlay } from '~/features/Toucan/Auction/BidDistributionChart/markers/BidMarkerOverlay'
import { useBidMarkerPositions } from '~/features/Toucan/Auction/BidDistributionChart/markers/useBidMarkerPositions'
import {
...
import { EXTENSION_PADDING_TICKS } from '~/features/Toucan/ToucanChart/bidDistribution/controller/logic/overlays'
import { ToucanBidDistributionChartController } from '~/features/Toucan/ToucanChart/bidDistribution/ToucanBidDistributionChartController'
import type {
...
function BidDistributionChartRendererComponent({
  ...
  const { renderLabels } = useChartLabels({
    ...
    tickSize: chartData.barStep ?? tickSizeDecimal,
