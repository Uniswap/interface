...
export const searchTokenToTokenSearchResult = (
  ...
  return {
    ...
    safetyInfo: getCurrencySafetyInfo(searchToken.project?.safetyLevel ?? undefined, searchToken.protectionInfo),
    feeData: searchToken.feeData
      ? {
          buyFeeBps: searchToken.feeData.buyFeeBps ?? undefined,
          sellFeeBps: searchToken.feeData.sellFeeBps ?? undefined,
        }
      : null,
  }
}
