...
interface BaseMorphoAssetTransactionInfo extends BaseTransactionInfo {
  assetAddress: string
...
interface BaseMorphoMarketTransactionInfo extends BaseMorphoAssetTransactionInfo {
  marketId: string
  marketTitle: string
}

interface BaseMorphoVaultTransactionInfo extends BaseMorphoAssetTransactionInfo {
  protocol: 'morpho-vault'
  vaultAddress: string
  vaultTitle: string
}

interface MorphoSupplyTransactionInfo extends BaseMorphoMarketTransactionInfo {
  type: TransactionType.MORPHO_SUPPLY
}

interface MorphoBorrowTransactionInfo extends BaseMorphoMarketTransactionInfo {
  type: TransactionType.BORROW
}

interface MorphoRepayTransactionInfo extends BaseMorphoMarketTransactionInfo {
  type: TransactionType.REPAY
}

interface MorphoMarketWithdrawTransactionInfo extends BaseMorphoMarketTransactionInfo {
  type: TransactionType.WITHDRAW_LIQUIDITY_STAKING
  protocol: 'morpho-market'
}

interface MorphoVaultDepositTransactionInfo extends BaseMorphoVaultTransactionInfo {
  type: TransactionType.DEPOSIT_LIQUIDITY_STAKING
}

interface MorphoVaultWithdrawTransactionInfo extends BaseMorphoVaultTransactionInfo {
  type: TransactionType.WITHDRAW_LIQUIDITY_STAKING
}

interface MorphoVaultRedeemTransactionInfo extends BaseTransactionInfo {
...
interface MorphoAuthorizationTransactionInfo extends BaseTransactionInfo {
...
export type TransactionInfo =
  ...
  | MorphoVaultDepositTransactionInfo
  | MorphoVaultWithdrawTransactionInfo
  | MorphoVaultRedeemTransactionInfo
  | MorphoAuthorizationTransactionInfo
  | WrapTransactionInfo
