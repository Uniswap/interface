...
export const colors = {
  ...
  neutral1_dark: '#C4D4C4',
  neutral2_dark: '#8FA98F',
  neutral3_dark: '#4A5F4A',
  surface1_dark: '#121212',
  surface1_hovered_dark: '#1A1A1A',
  surface2_dark: '#202020',
  surface3_dark: '#C4D4C440',
  surface4_dark: '#C4D4C460',
  surface5_dark: '#00000010',
  accent1_dark: '#3A9D23',
  accent2_dark: '#1E351A',
  accent3_dark: '#287B1B',
  neutral1_light: '#2B3A2B',
  neutral2_light: '#7FA27F',
  neutral3_light: '#C4D4C4',
  surface1_light: '#FFFFFF',
  surface1_hovered_light: '#F5F5F5',
  surface2_light: '#F9F9F9',
  ...
  surface4_light: '#FFFFFF64',
  surface5_light: '#00000004',
  accent1_light: '#3A9D23',
  accent2_light: '#D0F0D0',
  accent3_light: '#287B1B',
  success: '#28A745',
  critical: '#DC3545',
  critical2_dark: '#4A1F1A',
  critical2_light: '#FFE4E1',
