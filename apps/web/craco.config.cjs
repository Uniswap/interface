...
module.exports = {
  ...
  webpack: {
    ...
    configure: (webpackConfig) => {
      ...
      import('./scripts/copy-rive-wasm.mjs').catch(console.error)
      ...
      webpackConfig.resolve = Object.assign(webpackConfig.resolve, {
        alias: {
          ...
          '@ring-protocol/v2-sdk': require.resolve('@uniswap/v2-sdk'),
          '@ring-protocol/v3-sdk': require.resolve('@uniswap/v3-sdk'),
          '@ring-protocol/v4-sdk': require.resolve('@uniswap/v4-sdk'),
          '@ring-protocol/router-sdk': require.resolve('@uniswap/router-sdk'),
          '@ring-protocol/sdk-core': require.resolve('@uniswap/sdk-core'),
          '@ring-protocol/universal-router-sdk': require.resolve('@uniswap/universal-router-sdk'),
        },
