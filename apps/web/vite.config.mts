...
export default defineConfig(({ mode }) => {
  ...
  const overrides = {
    ...
    // Unify Uniswap/Ring-protocol SDK module identity to avoid instanceof mismatches
    '@ring-protocol/sdk-core': path.resolve(__dirname, '../../node_modules/@uniswap/sdk-core'),
    '@ring-protocol/v2-sdk': path.resolve(__dirname, '../../node_modules/@uniswap/v2-sdk'),
    '@ring-protocol/v3-sdk': path.resolve(__dirname, '../../node_modules/@uniswap/v3-sdk'),
    '@ring-protocol/v4-sdk': path.resolve(__dirname, '../../node_modules/@uniswap/v4-sdk'),
    '@ring-protocol/router-sdk': path.resolve(__dirname, '../../node_modules/@uniswap/router-sdk'),
    '@ring-protocol/universal-router-sdk': path.resolve(__dirname, '../../node_modules/@uniswap/universal-router-sdk'),
  }
  ...
  return {
    ...
    resolve: {
      ...
      dedupe: [
        ...
        '@ring-protocol/v4-sdk',
        '@ring-protocol/router-sdk',
        '@ring-protocol/universal-router-sdk',
        'jsbi',
        'ethers',
      ],
      alias: {
    ...
    plugins: [
      ...
      }),
      {
        name: 'copy-rive-wasm',
        async buildStart() {
          await import('./scripts/copy-rive-wasm.mjs')
        },
      },
      {
        name: 'svg-import-fix',
