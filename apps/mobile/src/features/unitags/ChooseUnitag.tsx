          ...
          <TooltipInfoButton
            ...
            modalIcon={
              <Flex centered row gap="$spacing4">
                <Pill
                  customBackgroundColor={colors.surface2.get()}
                ...
                <Pill
                  customBackgroundColor={colors.surface2.get()}
                  foregroundColor={colors.accent1.get()}
      ...
      <Flex fill justifyContent="space-between">
        ...
        <Flex gap="$spacing8">
          {entryPoint === OnboardingScreens.Landing && (
            <Button color="$accent1" size="large" theme="branded" onPress={onPressMaybeLater}>
              {t('Maybe later')}
            </Button>
          )}
          <Button size="large" theme="primary" onPress={onPressContinue}>
            {t('Continue')}
          </Button>
        </Flex>
      </Flex>
