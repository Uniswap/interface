...
interface CountrySelectorProps {
  onSelectCountry: (country: NonNullable<CountryPaymentMethodsResponse[0]>['country']) => void
  currentCountryCode: string
}

function key(item: NonNullable<CountryPaymentMethodsResponse[0]>): string {
...
function CountrySelectorContent({
  ...
  const renderItem = useCallback(
    ({ item }: ListRenderItemInfo<NonNullable<CountryPaymentMethodsResponse[0]>>): JSX.Element => {
