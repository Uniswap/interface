...
export function SearchResultsSection({
  ...
  const tokenResults = useMemo<TokenSearchResult[] | undefined>(() => {
    ...
    return formatTokenSearchResults(searchResultsData.searchTokens, selectedChain)
  }, [selectedChain, searchResultsData])
  ...
  const validAddress: Address | undefined = useMemo(
    () => getValidAddress({ address: searchQuery, withChecksum: true, log: false }) ?? undefined,
    [searchQuery],
  )
