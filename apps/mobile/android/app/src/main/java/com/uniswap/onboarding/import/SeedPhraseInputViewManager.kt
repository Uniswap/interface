...
class SeedPhraseInputViewManager : ViewGroupManager<ComposeView>() {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): ComposeView {
    ...
    // TODO gary move validation/wordlist logic to ethers
    val json = reactContext.assets.open("bip39_english.json").bufferedReader().use { it.readText() }
    val wordlist = Json.decodeFromString<List<String>>(json)
