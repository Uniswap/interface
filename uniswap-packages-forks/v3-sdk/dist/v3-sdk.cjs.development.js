...
var Route = /*#__PURE__*/function () {
  function Route(pools, input, output) {
    ...
    !pools[pools.length - 1].involvesToken(sdkCore.wrappedCurrency(output, chainId)) ?  invariant(false, 'OUTPUT')  : void 0;
    /**
  ...
  _createClass(Route, [{
    ...
    key: "inputToken",
    get: function get() {
      return sdkCore.wrappedCurrency(this.input, this.chainId);
    }
    /**
    ...
    key: "outputToken",
    get: function get() {
      return sdkCore.wrappedCurrency(this.output, this.chainId);
    }
    /**
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              amounts[0] = sdkCore.wrappedCurrencyAmount(amount, route.chainId);
              i = 0;
            ...
            case 19:
              ...
              amounts[amounts.length - 1] = sdkCore.wrappedCurrencyAmount(amount, route.chainId);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              amountIn = sdkCore.wrappedCurrencyAmount(nextAmountIn, chainId);
              tokenOut = sdkCore.wrappedCurrency(currencyOut, chainId);
              i = 0;
            ...
            case 12:
              ...
              if (!(!sdkCore.currencyEquals(pool.token0, amountIn.currency) && !sdkCore.currencyEquals(pool.token1, amountIn.currency))) {
                _context4.next = 16;
                break;
              }
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              !(chainId !== undefined) ?  invariant(false, 'CHAIN_ID')  : void 0;
              amountOut = sdkCore.wrappedCurrencyAmount(nextAmountOut, chainId);
              tokenIn = sdkCore.wrappedCurrency(currencyIn, chainId);
              i = 0;
            ...
            case 12:
              ...
              if (!(!sdkCore.currencyEquals(pool.token0, amountOut.currency) && !sdkCore.currencyEquals(pool.token1, amountOut.currency))) {
                _context5.next = 16;
                break;
              }
...
var NonfungiblePositionManager = /*#__PURE__*/function (_SelfPermit) {
  ...
  NonfungiblePositionManager.removeCallParameters = function removeCallParameters(position, options) {
    ...
    calldatas.push.apply(calldatas, NonfungiblePositionManager.encodeCollect(_extends({
      ...
      expectedCurrencyOwed0: expectedCurrencyOwed0.add(expectedCurrencyOwed0.currency.isEther ? sdkCore.CurrencyAmount.ether(amount0Min) : sdkCore.CurrencyAmount.fromRawAmount(expectedCurrencyOwed0.currency, amount0Min)),
      expectedCurrencyOwed1: expectedCurrencyOwed1.add(expectedCurrencyOwed1.currency.isEther ? sdkCore.CurrencyAmount.ether(amount1Min) : sdkCore.CurrencyAmount.fromRawAmount(expectedCurrencyOwed1.currency, amount1Min))
    }, rest)));
...
var SwapRouter = /*#__PURE__*/function (_SelfPermit) {
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    if (options.inputTokenPermit) {
      !trade.inputAmount.currency.isToken ?  invariant(false, 'NON_TOKEN_PERMIT')  : void 0;
    ...
    var mustRefund = trade.inputAmount.currency.isEther && trade.tradeType === sdkCore.TradeType.EXACT_OUTPUT; // flags for whether funds should be send first to the router
