...
import { NATIVE_ADDRESS, NATIVE_ADDRESS_ALT } from './addresses'
import { CHAIN_INFO, ChainId, isPolygonChain } from '../features/chains/chains'
...
export class NativeCurrency implements NativeCurrencyClass {
  ...
  private static cachedNativeCurrency: { [chainId: number]: NativeCurrency } =
    {}
