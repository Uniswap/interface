...
| Page | What it covers |
|---|---|
| [Overview](./overview.md) | Architecture, the fork stack (HooksOS/*), canonical init-code hashes |
...
| [SDK](./sdk.md) | The HooksOS/sdks fork; `@uniswap/*` overridden to HookSwap addresses |
| [Routing](./routing.md) | The Trading API adapter + smart-order-router; how quoting works |

## Key facts

- HookSwap = **own v2 + v3 + Universal Router** deployments of canonical Uniswap bytecode.
  **No v4, no hooks** on any chain.
