import BRAVE_ICON from 'assets/svg/wallets/brave-icon.svg'
import INJECTED_DARK_ICON from 'assets/svg/wallets/browser-wallet-dark.svg'
import INJECTED_LIGHT_ICON from 'assets/svg/wallets/browser-wallet-light.svg'
import LEDGER_ICON from 'assets/svg/wallets/ledger-icon.svg'
import METAMASK_ICON from 'assets/svg/wallets/metamask-icon.svg'
import PHANTOM_ICON from 'assets/svg/wallets/phantom-icon.svg'
import RABBY_ICON from 'assets/svg/wallets/rabby-icon.svg'
import TRUST_WALLET_ICON from 'assets/svg/wallets/trustwallet-icon.svg'
