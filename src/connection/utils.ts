...
const isBraveWallet = Boolean(window.ethereum?.isBraveWallet)
...
export const isMetaMaskWallet = Boolean(!window.ethereum?.isRabby && window.ethereum?.isMetaMask && !isBraveWallet)
