...
import COINBASE_ICON from 'assets/svg/wallets/coinbase-icon.svg'
import UNIWALLET_ICON from 'assets/svg/wallets/uniswap-wallet-icon.png'
import WALLET_CONNECT_ICON from 'assets/svg/wallets/walletconnect-icon.svg'
