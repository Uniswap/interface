...
describe('filterKnownErrors', () => {
  ...
  describe('chunk errors', () => {
    ...
    it('filters out 499 error coded chunk error', () => {
      const mockedEntries = [
        {
      ...
      getEntriesByTypeSpy.mockImplementation(() => mockedEntries)
    ...
    it('keeps 200 error coded chunk error', () => {
      ...
      expect(filterKnownErrors(ERROR, { originalException })).toBeDefined()
    })
  })
})
