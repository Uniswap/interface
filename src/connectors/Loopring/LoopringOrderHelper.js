...
export const constructLoopringOrder = (library, { primaryToken, owner, tokenB, tokenS, amountB, amountS, feeAmount, validUntil, transferDataS, broker, tokenRecipient }) => {
  return {
    owner: owner,
...
export const toDolomiteOrder = (order, orderSignature, {
  orderType, dependentTransaction, tokenB, tokenS, side,
  estimatedNumberOfFills, perMatchNetworkFee, constantNetworkFeePremium, position, isMargin, isOpen
}) => {
