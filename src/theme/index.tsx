...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    primary4: darkMode ? '#376bad70' : '#EDEEF270',
    primary5: darkMode ? '#153d6f70' : '#EDEEF270',
...
body {
  ...
  background-image: ${({ theme }) =>
    `radial-gradient(50% 50% at 50% 50%, ${transparentize(0.95, theme.primary1)} 0%, ${transparentize(
      1,
      theme.bg1
    )} 100%)`};
}
