...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    // color text
    primaryText1: darkMode ? '#6da8ff' : '#E8006F',
    ...
    // other
    red1: darkMode ? '#FD4040' : '#DA2D2B',
    red2: darkMode ? '#F82D3A' : '#DF1F38',
    red3: darkMode ? '#D60000' : '#D60000',
    green1: darkMode ? '#27AE60' : '#007D35',
    yellow1: darkMode ? '#e3a507' : '#956B14',
    yellow2: darkMode ? '#ff8f00' : '#B25B03',
    yellow3: darkMode ? '#F3B71E' : '#976A19',
    blue1: darkMode ? '#2172E5' : '#0068FC',
    blue2: darkMode ? '#5199FF' : '#0068FC',

    error: darkMode ? '#FD4040' : '#DF1F38',
    success: darkMode ? '#27AE60' : '#007D35',
    warning: darkMode ? '#ff8f00' : '#FF8F00',
