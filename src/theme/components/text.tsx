...
export const ThemedText = {
  ...
  BodyPrimary(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={16} color="textPrimary" {...props} />
  },
  BodySecondary(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={16} color="textSecondary" {...props} />
  },
  ...
  LabelMicro(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={12} color="textSecondary" {...props} />
  },
  Link(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={14} color="accentAction" {...props} />
  },
  MediumHeader(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={20} color="textPrimary" {...props} />
  },
  SubHeaderLarge(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={20} color="textPrimary" {...props} />
  },
  SubHeader(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={16} color="textPrimary" lineHeight="24px" {...props} />
  },
  ...
  DeprecatedMain(props: TextProps) {
    return <TextWrapper fontWeight={485} color="textSecondary" {...props} />
  },
  DeprecatedLink(props: TextProps) {
    return <TextWrapper fontWeight={485} color="accentAction" {...props} />
  },
  DeprecatedLabel(props: TextProps) {
    return <TextWrapper fontWeight={485} color="textPrimary" {...props} />
  },
  ...
  DeprecatedDarkGray(props: TextProps) {
    return <TextWrapper fontWeight={485} color="textTertiary" {...props} />
  },
  ...
  DeprecatedItalic(props: TextProps) {
    return <TextWrapper fontWeight={485} fontSize={12} fontStyle="italic" color="textSecondary" {...props} />
  },
  DeprecatedError({ error, ...props }: { error: boolean } & TextProps) {
    return <TextWrapper fontWeight={485} color={error ? 'accentFailure' : 'textSecondary'} {...props} />
  },
}
