...
import { CurrencyAmount, Fraction, JSBI, Percent, TokenAmount, Trade } from '@multiswap/sdk'
...
export function computeTradePriceBreakdown(
  ...
  const realizedLPFeeAmount =
    ...
    (trade.inputAmount instanceof TokenAmount
      ...
      : CurrencyAmount.baseForId(realizedLPFee.multiply(trade.inputAmount.raw).quotient, trade.route.chainId))
