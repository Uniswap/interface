import { Currency, currencyEquals, JSBI, Price, WETH } from 'dxswap-sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [chainId && wrapped?.equals(USDC[chainId]) ? undefined : wrapped, chainId && USDC[chainId]],
      [chainId ? WETH[chainId] : undefined, chainId && USDC[chainId]]
    ],
