...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'quickswap-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.MUMBAI, 'abc', 'address')).toEqual('https://rinkeby.etherscan.io/address/abc')
    })
  })
