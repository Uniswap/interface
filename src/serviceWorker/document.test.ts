...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.rigoblock.com', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.rigoblock.com', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.rigoblock.com', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.rigoblock.com', pathname: '/asset.gif' } }, false],
