...
export const FETH = new Token(80001, feth, 18, "fETH", "Fake ETH");
export const FUSDC = new Token(80001, fusdc, 18, "fUSDC", "Fake USDC")
export const FWBTC = new Token(80001, fwbtc, 18, "fWBTC", "Fake WBTC")
export const FDAI = new Token(80001, fdai, 18, "fDAI", "Fake DAI")
...
export const getFakePool = (token0?: string, token1?: string): string | undefined => {
  if (token0 === fusdc && token1 === feth) {
