...
export const V3_CORE_FACTORY_ADDRESSES = {
  [ChainId.MAINNET]: V3_FACTORY_ADDRESS,
  [ChainId.ROPSTEN]: V3_FACTORY_ADDRESS,
  [ChainId.RINKEBY]: V3_FACTORY_ADDRESS,
  [ChainId.GÖRLI]: V3_FACTORY_ADDRESS,
  [ChainId.KOVAN]: V3_FACTORY_ADDRESS,
...
export const QUOTER_ADDRESSES = {
  ...
  [ChainId.POLYGON_AMOY]: '0x81f1D9f16D42eF8009d14217cD3C0BE1B73494C0',
}
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.POLYGON_AMOY]: '0xeE925437D6b4be09883dA245050268Ac2AEE752b',
}
