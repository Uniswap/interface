...
export const FUSE_FOREIGN_BRIDGE_CHAIN = parseInt(unwrapOrThrow('FUSE_FOREIGN_BRIDGE_CHAIN'))
...
export const BINANCE_FOREIGN_BRIDGE_ADDRESS = unwrapOrThrow('BINANCE_FOREIGN_BRIDGE_ADDRESS')
export const BINANCE_HOME_BRIDGE_ADDRESS = unwrapOrThrow('BINANCE_HOME_BRIDGE_ADDRESS')
