...
export const FACTORY_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'contract IERC20', name: 'token0', type: 'address' },
      { indexed: true, internalType: 'contract IERC20', name: 'token1', type: 'address' },
      { indexed: false, internalType: 'address', name: 'pool', type: 'address' },
      { indexed: false, internalType: 'uint32', name: 'ampBps', type: 'uint32' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'feeTo', type: 'address' },
      { indexed: false, internalType: 'uint16', name: 'governmentFeeBps', type: 'uint16' }
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'feeToSetter', type: 'address' }],
    name: 'SetFeeToSetter',
    type: 'event'
  },
  {
  ...
  },
  {
    ...
    name: 'getPools',
    outputs: [{ internalType: 'address[]', name: '_tokenPools', type: 'address[]' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
