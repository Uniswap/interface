...
const CTOKEN_LISTS: { [chainId in ChainId]: [string, string, number, string, string, string, string][] } = {
  ...
  [ChainId.KOVAN]: [
  ['0x4a77faee9650b09849ff459ea1476eab01606c7a', '0x482dC9bB08111CB875109B075A40881E48aE02Cd', 18, 'cBAT', 'Compound BAT', 'BAT', 'Basic Attention Token'], // bat
  ['0x4a92e71227d294f041bd82dd8f78591b75140d63', '0xb7a4F3E9097C08dA09517b5aB877F7a917224ede', 6, 'cUSDC', 'Compound USDC', 'USDC', 'USD Coin'], // usdc
  ['0x41b5844f4680a8c38fbb695b7f9cfd1f64474a72', '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'cETH', 'Compound ETH', 'WETH', 'Wrapped Ether'], // eth
  ['0xA4eC170599a1Cf87240a35b9B1B8Ff823f448b57', '0x50DD65531676F718B018De3dc48F92B53D756996', 18, 'cREP', 'Compound REP', 'REP', 'Augur'], // rep
  ]
}
