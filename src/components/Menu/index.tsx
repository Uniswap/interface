...
import { Check, ChevronLeft, Globe, Info, MessageCircle, Moon, Sun } from 'react-feather'
          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://pi.cp0x.com/">
                      <div>
                        <Trans>About cp0x</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://t.me/cp0xdotcom">
                      <div>
