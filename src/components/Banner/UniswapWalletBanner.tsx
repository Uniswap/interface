...
import { BaseButton as LearnMoreButton, DownloadButton } from 'components/WalletDropdown/DownloadButton'
...
export default function UniswapWalletBanner() {
  ...
  const shouldDisplay = Boolean(!walletDropdownOpen && !hideUniswapWalletBanner && isMobile)
