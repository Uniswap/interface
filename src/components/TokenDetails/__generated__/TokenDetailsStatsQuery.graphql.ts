/**
 * @generated SignedSource<<d3e9e75551f947fa6545eaa10bcdcb4a>>
...
export type Currency = "USD" | "%future added value";
...
export type TokenDetailsStatsQuery = {
  response: TokenDetailsStatsQuery$data;
  variables: TokenDetailsStatsQuery$variables;
};
