...
import { PAGE_SIZE, useTopTokens2 } from 'graphql/data/TopTokens'
...
export default function TokenTable() {
  ...
  const { error, loading, tokens, sparklines, hasMore, loadMoreTokens, loadingRowCount } = useTopTokens2(chainName)
