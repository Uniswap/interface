...
export default function TokenDetails({
  ...
  const [openOneClickBuyModal, setOpenOneClickBuyModal] = useState(parsedQueryString['fire'] !== undefined)
  const [priceImpactSeverity, setPriceImpactSeverity] = useState(-1)
  ...
  return (
    ...
    >
      <TokenDetailsLayout>
        ...
        />
        <OneClickBuyModal
          isOpen={openOneClickBuyModal}
          close={() => setOpenOneClickBuyModal(false)}
          token={detailedToken}
