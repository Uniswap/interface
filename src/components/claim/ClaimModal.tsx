        ...
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              ...
              <ThemedText.White fontWeight={700} fontSize={36}>
                <Trans>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} XSP</Trans>
              </ThemedText.White>
            </CardSection>
            <Break />
            <CardSection gap="sm">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <ThemedText.SubHeader fontWeight={500}>
              <Trans>
                As a member of the XSwapProtocol community you may claim XSP to be used for voting and governance.
                <br />
                <br />
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="XSP" />
            )}
          </ConfirmedIcon>
