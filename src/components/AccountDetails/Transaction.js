...
const TransactionState = styled.div`
  ...
  background-color: ${({ pending, theme }) =>
    pending ? transparentize(0.95, theme.colors.blue5) : transparentize(0.95, theme.colors.green2)};
  ...
  border-color: ${({ pending, theme }) =>
    pending ? transparentize(0.75, theme.colors.blue5) : transparentize(0.75, theme.colors.green2)};
  ...
  :hover {
    border-color: ${({ pending, theme }) =>
      pending ? transparentize(0, theme.colors.blue5) : transparentize(0, theme.colors.green2)};
  }
`
const ButtonWrapper = styled.div`
  a {
    color: ${({ pending, theme }) => (pending ? theme.colors.blue5 : theme.colors.green2)};
  }
`
