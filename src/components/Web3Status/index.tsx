...
const Web3StatusConnected = styled(Web3StatusGeneric)<{ pending?: boolean }>`
  ...
  border: 2px solid ${({ pending, theme }) => (pending ? theme.primary1 : theme.bg0)};
  color: ${({ pending, theme }) => (pending ? theme.white : theme.text1)};
  font-weight: 500;
  :hover,
  :focus {
    background-color: ${({ pending, theme }) => (pending ? darken(0.05, theme.primary1) : lighten(0.05, theme.bg1))};
    border: 2px solid ${({ theme }) => darken(0.05, theme.bg1)};

    :focus {
      border: 2px solid ${({ pending, theme }) => (pending ? darken(0.1, theme.primary1) : darken(0.1, theme.bg2))};
    }
  }
`
