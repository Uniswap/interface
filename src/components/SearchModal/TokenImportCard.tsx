    ...
    <Card backgroundColor={theme.bg2} padding="2rem">
      <AutoColumn gap="10px" justify="center">
        ...
        <AutoColumn gap="4px" justify="center">
          <TextPreset.Body ml="8px" mr="8px" fontWeight={500} fontSize={20}>
            {token.symbol}
          </TextPreset.Body>
          <TextPreset.DarkGray fontWeight={400} fontSize={14}>
            {token.name}
          </TextPreset.DarkGray>
        </AutoColumn>
        {chainId && (
        ...
        {list !== undefined ? (
          <RowFixed>
            ...
            <TextPreset.Small ml="6px" fontSize={14} color={theme.text3}>
          ...
          <WarningWrapper $borderRadius="4px" padding="4px" highWarning={true}>
            <RowFixed>
              ...
              <TextPreset.Body color={theme.red1} ml="4px" fontSize="10px" fontWeight={500}>
