...
interface PayCurrencyInputPanelProps {
  value: string
  ...
  fiatValue?: { data?: CurrencyAmount<Currency>; isLoading: boolean }
  priceImpact?: Percent
  id: string
...
const PayCurrencyInputPanel = forwardRef<HTMLInputElement, PayCurrencyInputPanelProps>(
  (
    {
      value,
      onUserInput,
    ...
    const balanceInDollars = useUSDPrice(selectedCurrencyBalance)
            ...
            <FiatRow>
              <RowBetween>
                <LoadingOpacityContainer $loading={loading}>
                  {fiatValue && <CurrencyValue currencyAmount={fiatValue} />}
...
PayCurrencyInputPanel.displayName = 'PayCurrencyInputPanel'

export default PayCurrencyInputPanel
