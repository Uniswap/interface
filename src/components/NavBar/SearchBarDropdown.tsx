...
import { BACKEND_NOT_YET_SUPPORTED_CHAINS } from 'graphql/data/util'
...
export const SearchBarDropdown = (props: SearchBarDropdownProps) => {
  ...
  const showChainComingSoonBadge = chainId && BACKEND_NOT_YET_SUPPORTED_CHAINS.includes(chainId) && !isLoading
