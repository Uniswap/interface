...
const formatAnalyticsEventProperties = ({
  ...
  token_in_amount_usd: fiatInputValue ? parseFloat(fiatValueInput.toFixed(2)) : undefined,
  token_out_amount_usd: fiatOutputValue ? parseFloat(fiatValueOutput.toFixed(2)) : undefined,
