...
export default function SwapModalFooter({
  ...
  const callToAction: CallToAction = useMemo(() => {
    ...
    } else if (allowance.state === AllowanceState.REQUIRED && allowance.needsPermitSignature) {
      return {
            ...
            >
              {isLoading ? (
                ...
                <ThemedText.HeadlineSmall color="deprecated_accentTextLightPrimary">
                  {showProgressIndicatorV2 ? callToAction.buttonText : <Trans>Confirm swap</Trans>}
                </ThemedText.HeadlineSmall>
              )}
            </ConfirmButton>
            {showProgressIndicatorV2 && callToAction.helpLink && (
