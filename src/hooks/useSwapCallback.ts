...
function useSwapCallArguments(
  ...
  return useMemo(() => {
    if (!trade || !recipient || !library || !account || !deadline) return []
...
export function useSwapCallback(
  ...
  }, [trade, library, account, recipient, recipientAddressOrName, swapCalls, addTransactionWithType])
}
