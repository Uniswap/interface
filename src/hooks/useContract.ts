...
import QuoterJson from '@pollum-io/v2-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import TickLensJson from '@pollum-io/v2-periphery/artifacts/contracts/lens/TickLens.sol/TickLens.json'
...
import V3MigratorJson from '@pollum-io/v2-periphery/artifacts/contracts/V3Migrator.sol/V3Migrator.json'
...
import { NonfungiblePositionManager, Quoter, QuoterV2, TickLens, PegasysInterfaceMulticall } from 'types/v3'
