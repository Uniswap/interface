...
export function useBetterTrade(
  ...
  const v2TradeApprovalGasEstimateWei = BigNumber.from(10000) // TODO
  const v3TradeApprovalGasEstimateWei = BigNumber.from(10000) // TODO
  ...
  return useMemo(() => {
    if (!v2Trade || !weth || !v2SwapGasEstimateWei) {
      return undefined
    }
