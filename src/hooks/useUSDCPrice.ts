...
import { DAI_OPTIMISM, DAI_POLYGON_MUMBAI, USDC, USDC_ARBITRUM, USDC_POLYGON } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.POLYGON_MUMBAI]: CurrencyAmount.fromRawAmount(DAI_POLYGON_MUMBAI, 1e18),
}
