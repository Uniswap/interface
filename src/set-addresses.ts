...
CONVERTER_ADDRESS[ChainId.ARBITRUM_RINKEBY] = process.env.REACT_APP_SWPR_CONVERTER_ADDRESS_ARBITRUM_ONE as string // TODO: change to Arb1 before deploying
console.log('Arbitrum One SWPR converter address set to', CONVERTER_ADDRESS[ChainId.ARBITRUM_RINKEBY]) // TODO: change to Arb1 before deploying
