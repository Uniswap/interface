...
import { BackArrow, ExternalLink, TextPreset } from '../../theme'
...
function V2PairMigration({
  ...
  return (
    <AutoColumn gap="20px">
      <TextPreset.Body my={9} style={{ fontWeight: 400 }}>
        <Trans>
        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <TextPreset.Blue display="inline">
        ...
        <AutoColumn gap="lg">
          <RowBetween>
            <RowFixed style={{ marginLeft: '8px' }}>
              ...
              <TextPreset.MediumHeader style={{ marginLeft: '8px' }}>
                <Trans>
            ...
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              {v2SpotPrice && (
                <AutoColumn gap="8px" style={{ marginTop: '12px' }}>
                  <RowBetween>
                    <TextPreset.Body fontWeight={500} fontSize={14}>
                      <Trans>
          ...
          {largePriceDifference ? (
            <YellowCard>
              <AutoColumn gap="8px">
                ...
                <RowBetween>
                  <TextPreset.Body fontSize={14} color="inherit">
                    <Trans>Price Difference:</Trans>
                  </TextPreset.Body>
                  <TextPreset.Black fontSize={14} color="inherit">
                    <Trans>{priceDifferenceFraction?.toSignificant(4)}%</Trans>
                  </TextPreset.Black>
                </RowBetween>
              </AutoColumn>
              <TextPreset.Body fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
