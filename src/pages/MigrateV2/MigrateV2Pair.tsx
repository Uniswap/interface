...
import { CurrencyAmount, Fraction, Percent, Price, Token, V2_FACTORY_ADDRESSES } from '@kinetix/sdk-core'
import { FeeAmount, Pool, Position, priceToClosestTick, TickMath } from '@kinetix/v3-sdk'
        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <ThemedText.DeprecatedBlue display="inline">
              <Trans>Kinetix migration contract↗</Trans>
        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Kinetix V3 pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.DeprecatedBody fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Kinetix V3 at a price you believe is correct. <br />
