...
import { HideSmall, TextPreset } from 'theme'
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
                  ...
                  <Menu
                    ...
                    ToggleUI={(props: any) => (
                      <MoreOptionsButton {...props}>
                        <TextPreset.Body style={{ alignItems: 'center', display: 'flex' }}>
                          <Trans>More</Trans>
                          <ChevronDown size={15} />
                        </TextPreset.Body>
                      </MoreOptionsButton>
            ...
            <ResponsiveRow>
              ...
              {closedPositions.length > 0 ? (
                <ShowInactiveToggle>
                  <label>
                    <TextPreset.Body onClick={() => setUserHideClosedPositions(!userHideClosedPositions)}>
