...
const HeaderText = styled(TextPreset.Label)`
  align-items: center;
  display: flex;
  margin-bottom: 24px;
  font-weight: 400;
    ...
    <CTASection>
      <CTA1 href={'https://help.uniswap.org/en/articles/5391541-providing-liquidity-on-uniswap-v3'}>
        <ResponsiveColumn>
          ...
          <TextPreset.Body fontWeight={300} style={{ alignItems: 'center', display: 'flex', maxWidth: '80%' }}>
      ...
      <CTA2 href={infoLink + 'pools'}>
        <ResponsiveColumn>
          ...
          <TextPreset.Body fontWeight={300} style={{ alignSelf: 'flex-start' }}>
