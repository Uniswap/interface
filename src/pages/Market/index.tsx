...
export default function Market({ history }: RouteComponentProps) {
  ...
  const {
    ...
    paymentToken,
    paymentFee,
  } = useDerivedMarketInfo(toggledVersion, isGaslessMode)
  ...
  const priceImpactTooHigh = priceImpactSeverity > 3 && !isGaslessMode
                    ...
                    {!showWrap && trade && (
                      <div>
                        <Row justify={!trade ? 'center' : 'space-between'}>
                          ...
                          <RowFixed style={{ position: 'relative', top: '0px' }}>
                            <LoadingOpacityContainer $loading={routeIsSyncing}>
                              <TYPE.subHeader>
                        ...
                        <PageWrapper gap="lg" justify="center">
                          <WarningDescription>
                            <WrapperStyle>
                              ...
                              {CHAIN_NATIVE_TOKEN_SYMBOL[chainId ?? 1]}
                              <br />
                              <br />{' '}
                            </WrapperStyle>
                            This ETH wrapping operation may leave insufficient funds to cover any future on-chain
                            transaction costs.{' '}
                          </WarningDescription>
                          <StyledButton onClick={wrapToken}>
              ...
              {inputTokenShouldBeWrapped && (
                <PageWrapper gap="lg" justify="center">
                  <WarningDescription>
                    ...
                    This {CHAIN_NATIVE_TOKEN_SYMBOL[chainId ?? 1]} wrapping operation may leave insufficient funds to
                    cover any future on-chain transaction costs.{' '}
                  </WarningDescription>
