...
import { getDeviceId, sendAnalyticsEvent, sendAnalyticsEventIgnoreTracking, Trace, user } from 'analytics'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    sendAnalyticsEventIgnoreTracking(SharedEventName.APP_LOADED, pageLoadProperties)
    const sendWebVital =
      (metric: string) =>
      ({ delta }: Metric) =>
