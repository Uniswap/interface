import { initializeAnalytics, sendAnalyticsEvent, user } from 'analytics/amplitude'
import { CUSTOM_USER_PROPERTIES, EventName, PageName } from 'analytics/amplitude/constants'
