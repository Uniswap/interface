...
const eslintOptions = (args, defaultCacheLocation)=>({
        ...
        extensions: (ref = args["--ext"]) != null ? ref : [
            ".js",
            ".jsx",
            ".ts",
            ".tsx"
        ...
        rulePaths: (ref1 = args["--rulesdir"]) != null ? ref1 : [],
        fix: (ref2 = args["--fix"]) != null ? ref2 : false,
        fixTypes: (ref3 = args["--fix-type"]) != null ? ref3 : null,
...
const nextLint = async (argv)=>{
    ...
    var ref4;
    const files = (ref4 = args["--file"]) != null ? ref4 : [];
    var ref5;
    const dirs = (ref5 = args["--dir"]) != null ? ref5 : (ref7 = nextConfig.eslint) == null ? void 0 : ref7.dirs;
    const filesToLint = [
        ...dirs != null ? dirs : [],
        ...files
    ];
    ...
    var ref6;
    const maxWarnings = (ref6 = args["--max-warnings"]) != null ? ref6 : -1;
