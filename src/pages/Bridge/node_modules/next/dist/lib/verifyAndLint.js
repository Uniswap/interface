...
async function verifyAndLint(dir, cacheLocation, configLintDirs, numWorkers, enableWorkerThreads, telemetry, hasAppDir) {
    try {
        ...
        const lintDirs = (configLintDirs != null ? configLintDirs : _constants.ESLINT_DEFAULT_DIRS).reduce((res, d)=>{
