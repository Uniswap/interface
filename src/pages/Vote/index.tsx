    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{t('uniswapGovernance')}</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  {t('uniswapGovernanceDesc')}
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>{t('readMoreAboutGov')}</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TopSection gap="2px">
        ...
        {allProposals?.length === 0 && (
          <EmptyProposals>
            <TYPE.body style={{ marginBottom: '8px' }}>{t('noProposalsFound')}</TYPE.body>
            <TYPE.subHeader>
              <i>{t('noProposalsFoundDesc')} </i>
            </TYPE.subHeader>
          </EmptyProposals>
        )}
