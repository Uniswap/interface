import { Currency, ETHER, CurrencyAmount } from '@uniswap/sdk-core'
...
export default function PoolFinder() {
  ...
  const position: CurrencyAmount | undefined = useTokenBalance(account ?? undefined, pair?.liquidityToken)
