    ...
    return (
      <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
        <RowBetween align="flex-end">
          <Text fontSize={[16, 18, 24]} fontWeight={400}>
            {parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}
          </Text>
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyA} size={'24px'} />
            <Text fontSize={[16, 18, 24]} fontWeight={400} style={{ marginLeft: '10px' }}>
              {currencyA?.symbol}
            </Text>
          </RowFixed>
        </RowBetween>
        ...
        <TYPE.italic fontSize={16} color={theme.text2} textAlign="left" padding={'12px 0 0 0'}>
          <Trans>
            ...
            <LightCard>
              <AutoColumn gap="20px">
                ...
                <Row style={{ alignItems: 'flex-end' }}>
                  <Text fontSize={[48, 64, 72]} fontWeight={400}>
                  ...
                  <AutoColumn gap="10px">
                    <RowBetween>
                      ...
                      <RowFixed>
                        ...
                        <Text fontSize={[16, 18, 24]} fontWeight={400} id="remove-liquidity-tokena-symbol">
                          {currencyA?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
                    <RowBetween>
                      ...
                      <RowFixed>
                        ...
                        <Text fontSize={[16, 18, 24]} fontWeight={400} id="remove-liquidity-tokenb-symbol">
                          {currencyB?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
