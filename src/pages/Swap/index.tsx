import { CurrencyAmount, JSBI } from 'dxswap-sdk'
...
export default function Swap() {
  ...
  const { v2Trade, currencyBalances, parsedAmount, currencies, error } = useDerivedSwapInfo()
  ...
  const { priceImpactWithoutFee, realizedLPFeeAmount } = computeTradePriceBreakdown(trade)
