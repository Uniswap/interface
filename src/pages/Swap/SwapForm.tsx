...
import { initialState as initialSwapState } from 'state/swap/reducer'
...
export function SwapForm({
  ...
  const { state, dispatch, derivedSwapInfo, chainId, prefilledState } = useSwapContext()
  ...
  }, [dispatch, independentField, outputTokenHasTax, trade?.outputAmount])
