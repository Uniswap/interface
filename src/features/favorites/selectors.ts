...
import { HiddenNftsByAddress } from 'src/features/favorites/slice'
...
export const selectHiddenNfts = (state: RootState): HiddenNftsByAddress =>
  state.favorites.hiddenNfts
