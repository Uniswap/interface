// Copied from https://github.com/Uniswap/interface/blob/main/src/state/lists/reducer.test.ts
...
import { tokenListsReducer as reducer } from 'src/features/tokenLists/reducer'
import { TokenListsState } from 'src/features/tokenLists/types'
...
describe('list reducer', () => {
  let store: Store<TokenListsState>
  ...
  describe('updateVersion', () => {
    describe('never initialized', () => {
      ...
      it('clears the current lists', () => {
        ...
        expect(
          store.getState().byUrl['https://unpkg.com/@uniswap/default-token-list@latest']
        ).toBeUndefined()
      })
    ...
    describe('initialized with a different set of lists', () => {
      ...
      it('each of those initialized lists is empty', () => {
        ...
        // note we don't expect the uniswap default list to be pre-populated
        // this is ok.
