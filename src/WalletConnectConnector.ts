...
const InjectedConnectorErrorCodes = ['ETHEREUM_ACCESS_DENIED']
export default class WalletConnectConnector extends ErrorCodeMixin(Connector, InjectedConnectorErrorCodes) {
