...
describe('transaction reducer', () => {
  ...
  describe('clearAllTransactions', () => {
    it('removes all transactions for the chain', () => {
      ...
      expect(Object.keys(store.getState())).toEqual([String(ChainId.MATIC), String(ChainId.MUMBAI)])
      expect(Object.keys(store.getState()[ChainId.MATIC] ?? {})).toEqual(['0x0'])
      expect(Object.keys(store.getState()[ChainId.MUMBAI] ?? {})).toEqual(['0x1'])
