...
import useIsFreshBlock from 'lib/hooks/useIsFreshBlock'
...
export function useRoutingAPITrade<TTradeType extends TradeType>(
  ...
  const quoteResult: GetQuoteResult | undefined = useIsFreshBlock(Number(data?.blockNumber) || 0) ? data : undefined
