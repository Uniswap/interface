...
describe('Swap errors', () => {
  ...
  it('insufficient liquidity', () => {
    ...
    // The API takes a long and variable amount of time to return a 404, so setting the timeout to 60 seconds.
    cy.contains('Insufficient liquidity for this trade.', { timeout: 60000 })
