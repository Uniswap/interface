...
export const CHAIN_INFO: ChainInfo = {
  ...
  [UniverseChainId.Optimism]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Optimism
  ] satisfies L2ChainInfo,
  [UniverseChainId.Base]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Base
  ] satisfies L2ChainInfo,
  [UniverseChainId.BNB]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.BNB
  ] satisfies L2ChainInfo,
  [UniverseChainId.Polygon]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Polygon
  ] satisfies L2ChainInfo,
  [UniverseChainId.PolygonMumbai]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.PolygonMumbai
  ] satisfies L2ChainInfo,
  [UniverseChainId.Blast]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Blast
  ] satisfies L2ChainInfo,
  [UniverseChainId.Zora]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Zora
  ] satisfies L2ChainInfo,
  [UniverseChainId.Avalanche]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Avalanche
  ] satisfies L2ChainInfo,
  [UniverseChainId.Celo]: UNIVERSE_CHAIN_INFO[
    UniverseChainId.Celo
  ] satisfies L2ChainInfo,
  [UniverseChainId.TaraxaTestnet]:
    UNIVERSE_CHAIN_INFO[UniverseChainId.TaraxaTestnet],
