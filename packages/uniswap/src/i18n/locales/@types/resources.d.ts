interface Resources {
  "en-US": {
    ...
    "proposal.connectLayer1": "Please connect to Layer 1 Ethereum",
    "proposal.executionSubmitted": "Execution submitted",
    "proposal.layer1Warning": "Uniswap governance is only available on Layer 1. Switch your network to Ethereum Mainnet to view Proposals and Vote.",
