interface Resources {
  "en-US": {
    ...
    "addressInput.smartPool": "Target Smart Pool",
    ...
    "common.buyAndSell": "Buy and sell on Rigoblock",
    ...
    "grg.stakeFromPool": "Stake From Pool",
    "grg.stakeFromWallet": "Stake From Wallet",
    "grg.stakingFromPool": "Staking From Pool",
    "grg.stakingFromWallet": "Staking From Wallet",
    "grg.selfStake": "Stake From Pool",
    "grg.unlockingVotes": "Unlocking votes",
    "grg.voteOrDelegate": "By staking GRG to a Rigoblock Pool your activate your voting power. You keep 100% of votes.",
    "grg.votingShares": "Actively staked GRG tokens represent voting shares in Rigoblock governance.",
    ...
    "liquidityPool.page.title": "Add liquidity to pools{{version}} on Rigoblock",
    "liquidityPool.positions.closed.title": "Closed Positions",
    "liquidityPool.positions.page.title": "Manage {{quoteSymbol}}/{{baseSymbol}} pool liquidity on Rigoblock",
    "liquidityPool.positions.page.version.description": "View your active {{version}} liquidity positions. Add new positions.",
    "liquidityPool.positions.page.version.title": "Manage pool liquidity{{version}} on Rigoblock",
    ...
    "nft.collection.title": "Explore and buy on Rigoblock",
    ...
    "pool.addLiquidity.seoTitle": "Add liquidity to {{tokenPair}} ({{chain}}) on Rigoblock",
    ...
    "pool.smartPoolPosition": "Smart pool positions",
    ...
    "privacy.uniswaptos": "Rigoblock’s Terms of Service",
    "proposal.action": "Proposed action",
    "proposal.connectLayer1": "Please connect to one of the supported networks (Ethereum, Arbitrum, Base, Bsc, Optimism, or Polygon)",
    "proposal.executionSubmitted": "Execution submitted",
    "proposal.layer1Warning": "Rigoblock governance is not available on this network. Switch your network to a supported one (Ethereum, Arbitrum, Base, Bsc, Optimism or Polygon) to view Proposals and Vote.",
    "proposal.noneFound": "No proposals found.",
    "proposal.queue.delay": "Adding this proposal to the queue will allow it to be executed, after a delay.",
    "proposal.queueId": "Queue proposal {{proposalId}}",
    "proposal.queueing": "Queueing",
    "proposal.title": "Proposal Title",
    "proposal.willAppearHere": "Proposals submitted by community members will appear here.",
    "proposal.willEnact": "Executing this proposal will enact the calldata on-chain.",
    ...
    "routing.cheapest": "The Rigoblock client selects the cheapest trade option factoring price and network costs.",
    ...
    "settings.setting.language.description.extension": "Rigoblock defaults to your system language settings. To change your preferred language, go to your system settings.",
    ...
    "settings.setting.privacy.analytics.description": "We use anonymous usage data to enhance your experience across Rigoblock products. When disabled, we only track errors and essential usage.",
    ...
    "smartPools.noneFound": "No pools found",
    "smartPools.selector.search.placeholder": "Search smart pools",
    ...
    "swap.settings.routingPreference.option.default.description": "The Rigoblock client selects the cheapest trade option factoring price and network costs.",
    ...
    "swap.warning.networkFee.allow": "Allow {{ inputTokenSymbol }} (batched)",
    ...
    "title.buySellTradeEthereum": "Buy, sell & trade Ethereum and other top tokens on Rigoblock",
    "title.createGovernanceOn": "Create a new governance proposal on Rigoblock",
    "title.createGovernanceTo": "Create a new governance proposal to be voted on by GRG holders. Staked GRG tokens represent voting shares in Rigoblock governance.",
    ...
    "title.placeLimit": "Place limit orders on Rigoblock",
    ...
    "title.removePoolLiquidity": "Remove pool liquidity on Rigoblock",
    ...
    "title.sendTokens": "Send tokens on Rigoblock",
    ...
    "title.uniswapTradeCrypto": "Rigoblock | Trade crypto and NFTs safely on the top DeFi platform",
    "title.uniToken": "staked GRG tokens represent voting shares in Rigoblock governance. You keep your votes when staking to a pool.",
    "title.useImportTool": "Use this import tool to find v2 pools that don’t automatically appear in the interface.",
    "title.voteOnGov": "Vote on governance proposals on Rigoblock",
    ...
    "token.safety.warning.strong.heading.default_one": "This token isn’t traded on leading U.S. centralized exchanges or frequently swapped on Rigoblock.",
    "token.safety.warning.strong.heading.default_other": "These tokens aren’t traded on leading U.S. centralized exchanges or frequently swapped on Rigoblock.",
    "token.safety.warning.strong.heading.named": "{{tokenSymbol}} isn’t traded on leading U.S. centralized exchanges or frequently swapped on Rigoblock.",
    ...
    "token.safetyLevel.strong.message": "This token isn’t traded on leading U.S. centralized exchanges or frequently swapped on Rigoblock. Always conduct your own research before trading.",
    ...
    "vote.create.prompt": "Tip: Select an action and describe your proposal for the community. The proposal cannot be modified after submission, so please verify all information before submitting. The voting period will begin immediately and last for 7 days. To propose a custom action, <link>read the docs.</link>",
    "vote.landing.createProposal": "Create proposal",
    "vote.landing.delegatedTo": "Delegated to:",
    "vote.landing.edit": "(edit)",
    "vote.landing.minThresholdRequired.error": "A minimum threshold of 0.25% of the total UNI supply is required to submit proposals.",
    "vote.landing.proposals": "Proposals",
    "vote.landing.readMoreAboutRigoblockGovernance.link": "Read more about Rigoblock governance",
    "vote.landing.rigoblockGovernance": "Rigoblock governance",
    "vote.landing.self": "Self",
    "vote.landing.showCancelled": "Show cancelled",
    "vote.landing.unlockVoting": "Unlock voting",
    "vote.landing.voteAmount": "{{amount}} Votes",
    "vote.proposal.activeOrPendingProposal": "You already have an active or pending proposal",
    "vote.proposal.approveToken": "Approve token",
    "vote.proposal.notEnoughVotes": "You don’t have enough votes to submit a proposal",
    "vote.proposal.submitted": "Proposal submitted",
    "vote.proposal.title": "Proposal",
    "vote.proposal.transferToken": "Transfer token",
    "vote.proposal.voteThreshold": "You must have {{formattedProposalThreshold}} votes to submit a proposal",
    "vote.styled.active": "Active",
    "vote.styled.defeated": "Defeated",
    "vote.styled.succeeded": "Succeeded",
    "vote.styled.undetermined": "Undetermined",
    "vote.submitting": "Submitting vote",
    "vote.votePage.against": "Against",
    "vote.votePage.allProposals": "All Proposals",
    "vote.votePage.description": "Description",
    ...
    "vote.votePage.updateDelegation": "Update delegation",
    "vote.votePage.voteAgainst": "Vote against",
    "vote.votePage.voteFor": "Vote for",
    "vote.votePage.votingEnded": "Voting ended {{date}}",
    "vote.votePage.votingEnds": "Voting ends approximately {{date}}",
    "vote.votePage.votingStarts": "Voting starts approximately {{date}}",
    "wallet.appSignIn": "Sign in with the app",
    "wallet.connectingAgreement": "By connecting a wallet, you agree to Rigoblock’s <termsLink>Terms of Service</termsLink> and consent to its <privacyLink>Privacy Policy</privacyLink>.",
  ...
  "en-US_old": {
    ...
    "common.input.password.placeholder": "Password",
    "dapp.request.approve.action": "Approve",
    "dapp.request.approve.fallbackTitle": "Approve spending tokens",
    "dapp.request.approve.helptext": "Allow this site to access and spend this token from your wallet.",
    "dapp.request.approve.label": "Wallet",
    "dapp.request.approve.title": "Approve spending {{tokenSymbol}}",
    "dapp.request.base.title": "Confirm transaction",
    "dapp.request.changeChain.title": "Switch network to {{network}}",
    "dapp.request.connect.helptext": "Allow this site to view your wallet address, balance, and request approvals for transactions.",
    "dapp.request.connect.title": "Connect to site",
    "dapp.request.error.none": "No approvals pending",
    "dapp.request.fallback.calldata.label": "data",
    "dapp.request.fallback.function.label": "function",
    "dapp.request.fallback.recipient.label": "to",
    "dapp.request.fallback.sending.label": "sending",
    "dapp.request.permit2.description": "Permit2 manages token approvals across multiple dapps.",
    "dapp.request.permit2.header": "Sign Permit2",
    "dapp.request.permit2.price": "None",
    "dapp.request.signature.containsUnrenderableCharacters": "This message contains unrenderable characters. Make sure you trust this site.",
    "dapp.request.signature.error.712-spec-compliance": "SignTypedDataRequestContent received data for signing which does not comply with the EIP-712 spec.",
    "dapp.request.signature.header": "Signature request",
    "dapp.request.signature.toggleDataView.raw": "View raw data",
    ...
    "dapp.request.warning.notActive.message": "Make sure it’s the right one",
    "dapp.request.warning.notActive.title": "This is not your active wallet",
    "emptyTokenCard.description": "Buy or transfer tokens to this wallet to get started",
    "emptyTokenCard.title": "No tokens yet",
    "extension.connection.popup": "Your wallet isn’t connected to this site. Look for a “Connect Wallet” or “Log in” button.",
    "extension.connection.popupWithButton": "Your wallet isn’t connected to this site.",
    "extension.connection.titleConnected": "Connected",
    "extension.connection.titleNotConnected": "Not connected",
    "extension.lock.button.forgot": "Forgot password?",
    "extension.lock.button.help": "Get help",
    "extension.lock.button.recoveryPhrase": "Enter recovery phrase",
    "extension.lock.button.submit": "Unlock",
    "extension.lock.password.error": "Wrong password. Try again",
    "extension.lock.password.reset.description.default": "To reset your password, enter your wallet’s recovery phrase. Uniswap cannot help recover your password.",
    "extension.lock.password.reset.description.inProgress": "Follow the instructions on the browser web page to reset your password",
    "extension.lock.password.reset.title": "Forgot password?",
    "extension.lock.subtitle": "Enter your password to unlock",
    "extension.lock.title": "Welcome back",
    "extension.settings.password.enter.title": "Enter your current password",
    "extension.settings.password.error.wrong": "Wrong password",
    ...
    "onboarding.backup.manual.placeholder": "Secret word",
    "onboarding.backup.manual.progress": "{{completedStepsCount}}/{{totalStepsCount}} completed",
    "onboarding.backup.manual.subtitle_one": "What’s the <highlight/>{{count}}st</highlight/> word in your recovery phrase?",
    "onboarding.backup.manual.subtitle_two": "What’s the <highlight/>{{count}}nd</highlight/> word in your recovery phrase?",
    "onboarding.backup.manual.subtitle_few": "What’s the <highlight/>{{count}}rd</highlight/> word in your recovery phrase?",
    "onboarding.backup.manual.subtitle_other": "What’s the <highlight/>{{count}}th</highlight/> word in your recovery phrase?",
    "onboarding.backup.manual.title": "Let’s make sure you’ve recorded it correctly",
    "onboarding.backup.view.disclaimer": "I understand that if I lose my recovery phrase, Uniswap Labs cannot help me restore it",
    "onboarding.backup.view.subtitle.write": "Read the following carefully before continuing",
    "onboarding.backup.view.title": "Save your recovery phrase",
    "onboarding.backup.view.warning.message1": "This recovery phrase gives you full access to your wallet and funds",
    "onboarding.backup.view.warning.message2": "Write it down and keep it in a safe place",
    "onboarding.backup.view.warning.message3": "View this in private and <u>do not share it with anyone</u>",
    "onboarding.complete.button": "Open Uniswap Wallet",
    "onboarding.complete.description": "Your wallet is ready to swap, send, and receive crypto.",
    "onboarding.complete.pin.description": "Click on the puzzle icon in your toolbar and find Uniswap Wallet in the list",
    "onboarding.complete.pin.title": "Pin Uniswap Wallet",
    "onboarding.complete.title": "You’re all set",
    "onboarding.extension.connectMobile.button": "Import from your phone",
    "onboarding.extension.connectMobile.title": "Have the Uniswap mobile app?",
    "onboarding.extension.getOnTheBetaWaitlist.subtitle": "Download the mobile app to claim a username",
    "onboarding.extension.getOnTheBetaWaitlist.title": "Get on the Beta waitlist",
    "onboarding.extension.password.subtitle": "You’ll need this to unlock your wallet and access your recovery phrase",
    "onboarding.extension.password.title.default": "Create a password",
    "onboarding.extension.password.title.reset": "Reset your password",
    "onboarding.import.error.invalidWords_one": "1 word is invalid or misspelled",
    "onboarding.import.error.invalidWords_other": "{{count}} words are invalid or misspelled",
    "onboarding.importMnemonic.button.default": "My recovery phrase is 12 words",
    "onboarding.importMnemonic.button.longPhrase": "My recovery phrase is longer than 12 words",
    "onboarding.importMnemonic.error.invalidPhrase": "The phrase you entered is invalid",
    "onboarding.importMnemonic.subtitle": "Type or paste your 12-word recovery phrase",
    "onboarding.importMnemonic.title": "Enter your recovery phrase",
    "onboarding.intro.alreadyComplete.subtitle": "To create more wallets, open the account switcher inside the extension popup, or reinstall the extension to start over",
    "onboarding.intro.alreadyComplete.title": "You’ve already completed onboarding",
    "onboarding.intro.button.alreadyHave": "I already have a wallet",
    "onboarding.intro.title": "Welcome to \nUniswap Wallet",
    "onboarding.introBetaWaitlist.button.checkEligibility": "Check eligibility",
    "onboarding.introBetaWaitlist.button.letsGo": "Let’s go",
    "onboarding.introBetaWaitlist.checkEligibilityInstructions": "Enter your <highlight>uni.eth</highlight> username below to check if you’re eligible for the Beta.",
    "onboarding.introBetaWaitlist.eligible.tagline": "Welcome to the Beta — you’re one of the first to try out the Uniswap Extension.",
    "onboarding.introBetaWaitlist.eligible.title": "You’re off the waitlist!",
    "onboarding.introBetaWaitlist.ineligibleExplanation": "You’re still on the waitlist. We’ll notify you in the Uniswap mobile app when you become eligible!",
    "onboarding.introBetaWaitlist.unitagPlaceholder": "username",
    "onboarding.resetPassword.complete.safety": "Learn more about wallet safety",
    "onboarding.resetPassword.complete.subtitle": "Use your new password to unlock your wallet.",
    "onboarding.resetPassword.complete.title": "Password reset",
    "onboarding.scan.button": "Scan with Uniswap app",
    ...
    "send.recipientSelect.search.empty.message": "When you send tokens to a wallet address, they’ll show up here",
    "send.recipientSelect.search.empty.title": "No wallets saved",
    "send.recipientSelect.title": "To",
    "send.review.input.tokenAmount.title": "{{currencyAmount}} of {{currencySymbol}}",
    "send.review.modal.title": "You’re sending",
    "send.review.summary.button.title": "Confirm send",
    "send.search.empty.subtitle": "The address you typed either does not exist or is spelled incorrectly.",
    "send.search.empty.title": "No results found",
    ...
    "send.warning.modal.button.cta.cancel": "Cancel",
    "send.warning.modal.button.cta.confirm": "Confirm",
    "setting.recoveryPhrase.remove.button": "Remove recovery phrase",
    "setting.recoveryPhrase.remove.confirm.subtitle": "I understand that Uniswap Labs can’t help me recover my wallet if I failed to do so",
    "setting.recoveryPhrase.remove.confirm.title": "I saved my recovery phrase",
    "setting.recoveryPhrase.remove.initial.subtitle": "Make sure you’ve saved your recovery phrase. You will lose access to your funds otherwise",
    "setting.recoveryPhrase.remove.initial.title": "Before you continue",
    "setting.recoveryPhrase.remove.password.error": "Wrong password. Try again",
    "setting.recoveryPhrase.remove.password.input": "Enter password",
    "setting.recoveryPhrase.remove.subtitle": "Enter your password to continue",
    "setting.recoveryPhrase.remove.title": "You’re removing your recovery phrase",
    "setting.recoveryPhrase.view.error": "Wrong password, try again",
    "setting.recoveryPhrase.view.warning.message1": "Anyone who knows your recovery phrase can access your wallet and funds",
    "setting.recoveryPhrase.view.warning.message2": "View this in private",
    "setting.recoveryPhrase.view.warning.message3": "Do not share this with anyone",
    "setting.recoveryPhrase.view.warning.message4": "Never enter it to any websites or apps",
    "setting.recoveryPhrase.view.warning.title": "Before you continue",
    "settings.action.lock": "Lock wallet",
    "settings.setting.appearance.option.auto": "Auto",
    "settings.setting.beta.tooltip": "Coming soon",
    "settings.setting.gating.title": "Gating overrides",
    "settings.setting.giveFeedback.title": "Share feedback",
    "settings.setting.helpCenter.title": "Help center",
    "settings.setting.language.exampleTitle": "English",
    "settings.setting.password.title": "Change password",
    "settings.setting.recoveryPhrase.remove": "Remove recovery phrase",
    "settings.setting.recoveryPhrase.view": "View recovery phrase",
    "settings.setting.theme.title": "Theme",
    "swap.request.title.full": "Swap {{inputCurrencySymbol}} → {{outputCurrencySymbol}}",
    "swap.request.title.short": "Swap Tokens"
  }
}
