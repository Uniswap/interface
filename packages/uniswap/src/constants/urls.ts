...
export const UNISWAP_WEB_HOSTNAME = 'app.ring.exchange'
...
export const UNISWAP_APP_URL = 'https://ring.exchange/app'
export const UNISWAP_MOBILE_REDIRECT_URL = 'https://ring.exchange/mobile-redirect'

const helpUrl = 'https://support.ring.exchange/hc/en-us'
...
export const uniswapUrls = {
  ...
  tradingApiUrl_rw: config.tradingApiUrlOverride_rw,
...
export const ringswapUrls = {
  ringswaphooksUrl: 'https://ringprotocol.gitbook.io/ring/docs/hook-contracts-guide',
}
