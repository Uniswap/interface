...
export const UNIVERSE_CHAIN_INFO = {
  ...
  [UniverseChainId.ArbitrumOne]: {
    ...arbitrum,
    id: UniverseChainId.ARBITRUM_ONE,
  ...
  [UniverseChainId.ARBITRUM_GOERLI]: {
    ...arbitrumGoerli,
    id: UniverseChainId.ARBITRUM_GOERLI,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Arbitrum as InterfaceGqlChain,
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://arbitrum-goerli.infura.io/v3/${config.infuraKey}`],
      },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
      USDC_ARBITRUM_GOERLI,
  ...
  [UniverseChainId.OPTIMISM_GOERLI]: {
    ...optimismGoerli,
    id: UniverseChainId.OPTIMISM_GOERLI,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Optimism as InterfaceGqlChain,
      isSecondaryChain: true,
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://optimism-goerli.infura.io/v3/${config.infuraKey}`],
      },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
      USDC_OPTIMISM_GOERLI,
  ...
  [UniverseChainId.PolygonMumbai]: {
    ...polygonMumbai,
    id: UniverseChainId.POLYGON_MUMBAI,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Polygon as InterfaceGqlChain,
      isSecondaryChain: true,
    ...
    rpcUrls: {
      [RPCType.PublicAlt]: {
        http: ["https://rpc-endpoints.superfluid.dev/mumbai"],
      },
      default: { http: ["https://rpc-mumbai.maticvigil.com"] },
      appOnly: {
        http: [`https://polygon-mumbai.infura.io/v3/${config.infuraKey}`],
      },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
      USDC_POLYGON_MUMBAI,
  ...
  [UniverseChainId.Blast]: {
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://blast-mainnet.infura.io/v3/${config.infuraKey}`],
      },
    },
    wrappedNativeCurrency: {
      name: "Wrapped Ether",
  ...
  [UniverseChainId.AVALANCHE]: {
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://avalanche-mainnet.infura.io/v3/${config.infuraKey}`],
      },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
      USDC_AVALANCHE,
  ...
  [UniverseChainId.CELO]: {
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://celo-mainnet.infura.io/v3/${config.infuraKey}`],
      },
    },
    wrappedNativeCurrency: {
      name: "Celo",
  ...
  [UniverseChainId.CELO_ALFAJORES]: {
    ...celoAlfajores,
    id: UniverseChainId.CELO_ALFAJORES,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Celo as InterfaceGqlChain,
      isSecondaryChain: true,
    ...
    rpcUrls: {
      ...
      appOnly: {
        http: [`https://celo-alfajores.infura.io/v3/${config.infuraKey}`],
      },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
      CUSD_CELO_ALFAJORES,
  ...
  [UniverseChainId.TaraxaTestnet]: {
    ...
    blockPerMainnetEpochForChainId: 15,
  ...
  [UniverseChainId.Taraxa]: {
    ...
    backendChain: {
      chain: BackendChainId.Taraxa as InterfaceGqlChain,
      backendSupported: false,
      isSecondaryChain: false,
      nativeTokenBackendAddress: undefined,
    },
    ...
    pendingTransactionsRetryOptions: undefined,
    rpcUrls: {
      [RPCType.Public]: { http: ["https://rpc.mainnet.taraxa.io"] },
      default: { http: ["https://rpc.mainnet.taraxa.io"] },
      appOnly: { http: ["https://rpc.mainnet.taraxa.io"] },
    },
    urlParam: "taraxa",
    statusPage: undefined,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(
