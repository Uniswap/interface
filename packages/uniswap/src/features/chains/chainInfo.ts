...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniverseChainId.Bnb]: {
    ...
    rpcUrls: {
      [RPCType.Public]: {
       //http: [getQuicknodeEndpointUrl(UniverseChainId.Bnb)] },
        http: [`https://bsc-mainnet.infura.io/v3/${config.infuraKey}`],
      },
      [RPCType.Default]: { http: ['https://bsc-dataseed1.bnbchain.org'] },
      [RPCType.Interface]: { http: [`https://bsc-mainnet.infura.io/v3/${config.infuraKey}`, getQuicknodeEndpointUrl(UniverseChainId.Bnb)] },
    },
