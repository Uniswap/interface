...
export const megaETHEvm = /*#__PURE__*/ defineChain({
  id: 4326,
  name: 'MegaETHEVM',
...
export function getQuicknodeChainId(chainId: UniverseChainId): string {
  switch (chainId) {
    ...
    case UniverseChainId.Celo:
      return 'celo-mainnet'
    case UniverseChainId.HyperMainnet:
...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  [UniverseChainId.Mainnet]: {
    ...
    infoLink: 'https://ring.exchange/explore',
  ...
  [UniverseChainId.ArbitrumOne]: {
    ...
    helpCenterUrl: 'https://help.ring.exchange/en/collections/3137787-uniswap-on-arbitrum',
    infoLink: 'https://ring.exchange/explore/tokens/arbitrum',
  ...
  [UniverseChainId.Avalanche]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/avalanche',
  ...
  [UniverseChainId.Base]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/base',
    interfaceName: 'base',
    label: 'Base',
    logo: BASE_LOGO,
    nativeCurrency: {
  ...
  [UniverseChainId.Blast]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/blast',
  ...
  [UniverseChainId.Bnb]: {
    ...
    infoLink: 'https://ring.exchange/explore/tokens/bnb',
    ...
    pendingTransactionsRetryOptions: undefined,
    rpcUrls: {
      [RPCType.Public]: { http: [`https://bnb-mainnet.g.alchemy.com/v2/${config.alchemyApiKey}`] },
  ...
  [UniverseChainId.Celo]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/celo',
  ...
  [UniverseChainId.HyperMainnet]: {
    ...hyperEvm,
    id: UniverseChainId.HyperMainnet,
    sdkId: UniswapSDKChainId.HYPER_MAINNET,
    assetRepoNetworkName: 'hyperEvm',
    backendChain: {
      chain: BackendChainId.Hyper as GqlChainId,
      backendSupported: true,
      isSecondaryChain: false,
      nativeTokenBackendAddress: undefined,
    },
    ...
    blockWaitMsBeforeWarning: 600000,
    bridge: 'https://www.hyperbridge.xyz/',
    docs: 'https://hyperliquid.gitbook.io/',
    elementName: ElementName.ChainHyper,
    explorer: {
      name: 'HyperEVMScan',
      url: 'https://hyperevmscan.io/',
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/hyper',
    infuraPrefix: 'hyper-mainnet',
    ...
    nativeCurrency: {
      ...
      decimals: 18,
      address: DEFAULT_NATIVE_ADDRESS_LEGACY,
      explorerLink: 'https://hyperevmscan.io/chart/hypeprice',
      logo: HYPER_EVM_LOGO,
    },
    networkLayer: NetworkLayer.L2,
    pendingTransactionsRetryOptions: DEFAULT_RETRY_OPTIONS,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_HYPER_MAINNET, 10_000e6),
    stablecoins: [USDC_HYPER_MAINNET],
    statusPage: undefined,
    supportsInterfaceClientSideRouting: true,
    supportsGasEstimates: true,
    supportsV4: false,
    urlParam: 'hyper',
    rpcUrls: {
      [RPCType.Public]: { http: [`https://hyperliquid-mainnet.g.alchemy.com/v2/${config.alchemyApiKey}`] },
      [RPCType.Default]: { http: ['https://rpc.hyperliquid.xyz/evm'] },
      [RPCType.Interface]: {
        http: [
          `https://hyperliquid-mainnet.g.alchemy.com/v2/${config.alchemyApiKey}`,
          getQuicknodeEndpointUrl(UniverseChainId.HyperMainnet),
        ],
      },
    },
    wrappedNativeCurrency: {
  ...
  [UniverseChainId.MEGAETHMainnet]: {
    ...megaETHEvm,
    id: UniverseChainId.MEGAETHMainnet,
    sdkId: UniswapSDKChainId.MEGAETH_MAINNET,
    assetRepoNetworkName: 'megaETHEvm',
    backendChain: {
      chain: BackendChainId.Megaeth as GqlChainId,
      backendSupported: true,
      isSecondaryChain: false,
      nativeTokenBackendAddress: undefined,
    },
    ...
    docs: 'https://docs.megaeth.com/frontier/',
    elementName: ElementName.ChainMegaETH,
    explorer: {
      name: 'MegaETHScan',
      url: 'https://mega.etherscan.io/',
      apiURL: 'https://api.megaeth.blockscout.com',
    },
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/megaeth',
    infuraPrefix: 'megaeth-mainnet',
    ...
    networkLayer: NetworkLayer.L2,
    pendingTransactionsRetryOptions: DEFAULT_RETRY_OPTIONS,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDM_MEGAETH_MAINNET, 10_000e18),
    stablecoins: [USDM_MEGAETH_MAINNET],
    statusPage: undefined,
    supportsInterfaceClientSideRouting: true,
    supportsGasEstimates: true,
    supportsV4: false,
    urlParam: 'megaeth',
    rpcUrls: {
      [RPCType.Public]: { http: [`https://megaeth-mainnet.g.alchemy.com/v2/${config.alchemyApiKey}`] },
      [RPCType.Default]: { http: ['https://mainnet.megaeth.com/rpc'] },
      [RPCType.Interface]: {
        http: [`https://megaeth-mainnet.g.alchemy.com/v2/${config.alchemyApiKey}`],
      },
    },
    wrappedNativeCurrency: {
  ...
  [UniverseChainId.Optimism]: {
    ...
    helpCenterUrl: 'https://help.ring.exchange/en/collections/3137778-uniswap-on-optimistic-ethereum-oξ',
    infoLink: 'https://ring.exchange/explore/tokens/optimism',
  ...
  [UniverseChainId.Polygon]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/polygon',
  ...
  [UniverseChainId.Sepolia]: {
    ...
    rpcUrls: {
      ...
      [RPCType.Interface]: { http: [`https://eth-sepolia.g.alchemy.com/v2/${config.alchemyApiKey}`] },
    },
  ...
  [UniverseChainId.Soneium]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/soneium',
    infuraPrefix: undefined,
  ...
  [UniverseChainId.Unichain]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/unichain',
  ...
  [UniverseChainId.UnichainSepolia]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore', // need
  ...
  [UniverseChainId.WorldChain]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/ethereum/0x163f8c2467924be0ae7b5347228cabf260318753',
    infuraPrefix: undefined,
  ...
  [UniverseChainId.Zksync]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/zksync',
    infuraPrefix: undefined,
  ...
  [UniverseChainId.XLayer]: {
    ...
    sdkId: 196 as UniswapSDKChainId,
    testnet: false,
    assetRepoNetworkName: 'xlayer',
    backendChain: {
      chain: BackendChainId.Xlayer as GqlChainId,
      backendSupported: true,
      isSecondaryChain: false,
      nativeTokenBackendAddress: undefined,
    },
    ...
    blockWaitMsBeforeWarning: isInterface ? DEFAULT_MS_BEFORE_WARNING : ONE_MINUTE_MS,
    bridge: undefined,
    docs: 'https://www.okx.com/web3/build/docs/evm/xlayer',
    ...
    rpcUrls: {
      ...
      [RPCType.Default]: { http: ['https://rpc.xlayer.tech', 'https://xlayerrpc.okx.com'] },
      [RPCType.Interface]: { http: [getQuicknodeEndpointUrl(UniverseChainId.XLayer)] },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_XLAYER_MAINNET, 10_000e6),
    stablecoins: [USDC_XLAYER_MAINNET],
    statusPage: undefined,
    supportsInterfaceClientSideRouting: true,
    supportsGasEstimates: true,
    supportsV4: true,
  ...
  [UniverseChainId.Zora]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://ring.exchange/explore/tokens/zora',
    infuraPrefix: undefined,
    interfaceName: 'zora',
    label: 'Zora Network',
    logo: ZORA_LOGO,
