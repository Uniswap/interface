export enum InterfaceEventName {
  ...
  ChartSettingSelected = 'Chart Setting Selected',
  ...
  ExploreTableFilterSelected = 'Explore Table Filter Selected',
  ExploreTableSorted = 'Explore Table Sorted',
  ...
  LimitCancelBroadcast = 'Limit Cancel Broadcast',
  LimitCancelBroadcastFailed = 'Limit Cancel Broadcast Failed',
  LimitCancelConfirmed = 'Limit Cancel Confirmed',
  LimitCancelRevertClicked = 'Limit Cancel Revert Clicked',
  LimitCancelTimeoutAlertShown = 'Limit Cancel Timeout Alert Shown',
