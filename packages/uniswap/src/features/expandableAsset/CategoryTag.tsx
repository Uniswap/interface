 ...
 *  category tags (e.g. Commodities): add a `case` once the data layer classifies that category and a matching
 *  i18n string + icon exist. Returns `undefined` for categories without a tag (e.g. UNSPECIFIED) so the tag
 *  renders nothing. */
