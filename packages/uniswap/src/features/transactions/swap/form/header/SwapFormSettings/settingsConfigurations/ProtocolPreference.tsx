...
import { Flex, Switch, Text, TouchableArea, UniswapXText, isWeb, type FlexProps } from 'ui/src'
import { InfoCircleFilled } from 'ui/src/components/icons/InfoCircleFilled'
import { UniswapX } from 'ui/src/components/icons/UniswapX'
import { colors, opacify, spacing, zIndexes } from 'ui/src/theme'
...
import { UniswapXUnavailableModal } from 'uniswap/src/features/smartWallet/modals/UniswapXUnavailableModal'
...
export const ProtocolPreference: SwapSettingConfig = {
  ...
  Control() {
    ...
    const getTradeProtocolPreferenceTitle = useMemo((): string => {
      if (isDefaultOptions(selectedProtocols, isV4HookPoolsEnabled, isV4HooksToggleFFEnabled)) {
  ...
  Screen() {
    ...
    const [isDefault, setIsDefault] = useState(
      isDefaultOptions(selectedProtocols, isV4HookPoolsEnabled, isV4HooksToggleFFEnabled),
    )
...
const UniswapXNotSupportedDescription = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <UniswapXUnavailableModal isOpen={showModal} onClose={() => setShowModal(false)} />
    </>
  )
}
  ...
  return (
    <WarningModal
      ...
      {...{
        ...
        caption: `${t('uniswapx.description')} ${t('uniswapx.description.unsupported')}`,
        rejectText: t('common.button.close'),
