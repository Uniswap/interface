...
/** Index of the step that will not be animated. */
const NO_ANIMATION_INDEX = -1
/** Index of the initial plan fetch step. */
const PLAN_FETCH_STEP_INDEX = 0
...
/**
 * Web-specific button used after the user has submitted a swap and the swap is pending.
...
export function PendingSwapButton({ disabled, onSubmit }: PendingSwapButtonProps): JSX.Element {
  const { progress, transitionDuration } = useSwapProgressState()
