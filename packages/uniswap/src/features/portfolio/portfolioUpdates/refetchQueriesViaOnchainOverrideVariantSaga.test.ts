...
describe('mergeOnChainBalances', () => {
  ...
  it('should update USD value when balance changes', () => {
    ...
    const onchainBalances: OnChainMap = new Map([[mockCurrencyId, onchainBalance]])
  ...
  it('should add new balances for tokens not in portfolio', () => {
    ...
    const onchainBalances: OnChainMap = new Map([[newCurrencyId, newOnchainBalance]])
  ...
  it('should not add new balances for tokens with zero balance', () => {
    ...
    const onchainBalances: OnChainMap = new Map([[newCurrencyId, zeroOnchainBalance]])
  ...
  it('should not add new balances for tokens with negative balance', () => {
    ...
    const onchainBalances: OnChainMap = new Map([[newCurrencyId, negativeOnchainBalance]])
  ...
  it('should remove balances that become zero', () => {
    ...
    const onchainBalances: OnChainMap = new Map([[mockCurrencyId, zeroBalance]])
