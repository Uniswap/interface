...
export interface Config {
  ...
  tradingApiUrlOverride_rw: string
...
const _config: Config = {
  ...
  amplitudeProxyUrlOverride:
    process.env.REACT_APP_AMPLITUDE_PROXY_URL_OVERRIDE ||
    process.env.AMPLITUDE_PROXY_URL_OVERRIDE ||
    AMPLITUDE_PROXY_URL_OVERRIDE,
  apiBaseUrlOverride:
    process.env.REACT_APP_TRADING_API_URL_OVERRIDE_RW || process.env.API_BASE_URL_OVERRIDE || API_BASE_URL_OVERRIDE,
  apiBaseUrlV2Override:
    process.env.REACT_APP_API_BASE_URL_V2_OVERRIDE || process.env.API_BASE_URL_V2_OVERRIDE || API_BASE_URL_V2_OVERRIDE,
  ...
  graphqlUrlOverride: process.env.REACT_APP_AWS_API_ENDPOINT || process.env.REACT_APP_GRAPHQL_URL_OVERRIDE || '',
  ...
  statsigProxyUrlOverride:
    process.env.REACT_APP_STATSIG_PROXY_URL_OVERRIDE ||
    process.env.STATSIG_PROXY_URL_OVERRIDE ||
    STATSIG_PROXY_URL_OVERRIDE,
  ...
  tradingApiUrlOverride_rw: process.env.REACT_APP_TRADING_API_URL_OVERRIDE_RW || '',
