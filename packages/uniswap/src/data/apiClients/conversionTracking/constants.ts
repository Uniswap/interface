...
import ms from 'ms'
import { PlatformIdType } from 'uniswap/src/data/apiClients/conversionTracking/types'
...
// Conversion tracking is proxied through the Entry Gateway — reuse the canonical URLs.
export const DEV_CONVERSION_PROXY_API_BASE_URL = DEV_ENTRY_GATEWAY_API_BASE_URL
export const STAGING_CONVERSION_PROXY_API_BASE_URL = STAGING_ENTRY_GATEWAY_API_BASE_URL
export const PROD_CONVERSION_PROXY_API_BASE_URL = PROD_ENTRY_GATEWAY_API_BASE_URL
