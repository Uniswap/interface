...
vi.mock('uniswap/src/data/reactQuery/createPersister', () => ({
  createPersister: () => ({}),
}))
...
import { SharedPersistQueryClientProvider } from 'uniswap/src/data/reactQuery/SharedPersistQueryClientProvider.native'
