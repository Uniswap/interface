...
export const [EtherscanLogoDark, AnimatedEtherscanLogoDark] = createIcon({
  name: 'EtherscanLogoDark',
  getIcon: (props) => (
    <Svg viewBox="0 0 293.775 293.667" {...props}>
