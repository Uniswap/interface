...
const Icon = forwardRef<Svg, IconProps>((props, ref) => {
  ...
  return (
    <Svg ref={ref} height={size} viewBox="0 0 293.775 293.667" width={size} {...svgProps}>
...
Icon.displayName = 'EtherscanLogoDark'

export const EtherscanLogoDark = memo<IconProps>(Icon)
