...
const Icon = forwardRef<Svg, IconProps>((props, ref) => {
  ...
  return (
    <Svg ref={ref} height={size} viewBox="0 0 293.775 293.671" width={size} {...svgProps}>
...
Icon.displayName = 'EtherscanLogoLight'

export const EtherscanLogoLight = memo<IconProps>(Icon)
