...
export const CITREA_LOGO = require('./logos/citrea.png')
...
export const JUICESWAP_FAVICON = require('./JuiceSwapFavIcon.png')
export const JUICESWAP_FAVICON_192 = require('./JuiceSwapFavIcon_192.png')
export const JUICESWAP_LOGO_SVG = require('./JuiceSwapLogo.svg')
export const BINANCE_WALLET_ICON = require('./logos/png/binance-icon.png')
export const RABBY_WALLET_ICON = require('./logos/png/rabby-wallet-icon.png')
