...
export const NEXTRADE_LOGO = require('./logos/png/nextrade-logo.png')
export const NEXTRADE_LOGO_LARGE = require('./logos/png/nextrade-logo-large.png')
export const NEXTRADE_MONO_LOGO_LARGE = require('./logos/png/nextrade-mono-logo-large.png')
export const NEXTRADE_APP_ICON = require('./logos/png/nextrade-app-icon.png')
