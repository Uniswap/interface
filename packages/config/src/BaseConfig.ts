...
export const BaseConfigValues = {
  ...
  dataApiBaseUrlV2Override: process.env.DATA_API_BASE_URL_V2_OVERRIDE,
...
export const BaseConfigSchema = z.object({
  ...
  dataApiBaseUrlV2Override: optionalString.describe('Override URL for the DataApi base v2 (HookSwap data-api)'),
