...
import {
  ...
  storeNeckMetadata,
  storeNeckSigningKey,
} from '@universe/embedded-wallet/src/features/passkey/deviceSession'
...
} from '@universe/embedded-wallet/src/features/passkey/authenticatorManagement'
export {
  authenticateWithPasskey,
  refreshNeckSession,
} from '@universe/embedded-wallet/src/features/passkey/passkeySession'
export type { SetupProgress } from '@universe/embedded-wallet/src/features/passkey/recoverySetup'
export {
  encryptAndStoreRecovery,
  RecoveryOprfError,
} from '@universe/embedded-wallet/src/features/passkey/recoverySetup'
...
export type { GetExportCredentialFn } from '@universe/embedded-wallet/src/features/passkey/signing'
