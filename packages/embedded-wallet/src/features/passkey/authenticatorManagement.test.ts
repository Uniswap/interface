...
vi.mock('@universe/embedded-wallet/src/features/passkey/passkeySession', () => ({
  authenticateWithPasskey: vi.fn(),
  refreshNeckSession: vi.fn(),
}))

vi.mock('@universe/embedded-wallet/src/features/passkey/deviceSession', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@universe/embedded-wallet/src/features/passkey/deviceSession')>()
  return {
    ...actual,
...
vi.mock('@universe/embedded-wallet/src/features/passkey/passkey', () => ({
