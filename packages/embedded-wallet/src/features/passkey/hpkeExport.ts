...
import {
  ...
  type GetExportCredentialFn,
} from '@universe/embedded-wallet/src/features/passkey/embeddedWallet'
import { executeRecoveryExport } from '@universe/embedded-wallet/src/features/passkey/recoveryExecute'
...
export async function decryptHpkeCiphertext({
  ...
  return uint8ToUtf8(new Uint8Array(plaintext))
}
