...
import { RecoveryStep, useRecoveryFlow } from '@universe/embedded-wallet/src/features/passkey/useRecoveryFlow'
...
vi.mock('@universe/embedded-wallet/src/features/passkey/recoveryRotate', () => ({
