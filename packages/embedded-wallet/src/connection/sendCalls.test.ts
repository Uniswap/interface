...
vi.mock('@universe/embedded-wallet/src/connection/bundlerClient', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@universe/embedded-wallet/src/connection/bundlerClient')>()),
