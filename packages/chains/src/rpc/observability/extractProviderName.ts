const PROVIDER_PATTERNS: [RegExp, string][] = [
  // Uniswap entry gateway (UniRPC) — match before paid providers so metrics
  // tag these calls as 'unirpc' instead of falling through to the raw hostname.
  [/entry-gateway\..*\.api\.uniswap\.org/, 'unirpc'],
  // Paid providers
